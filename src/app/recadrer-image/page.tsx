  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Découpez et recadrez vos images avec précision. Sélectionnez la zone à conserver et téléchargez le résultat immédiatement. Compatible JPG, PNG et WebP. Gratuit, sans inscription, aucun fichier conservé sur nos serveurs.</p>
      </div>
