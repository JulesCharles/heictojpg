...
export const metadata: Metadata = {
  title: "HEIC vs AVIF : quel format choisir ? Comparatif [2026]",
  description:
  ...
  keywords: [
    "heic vs avif",
    "heic ou avif",
    "difference heic avif",
    "format photo moderne",
    "heic avif comparaison",
    "avif apple",
    "convertir heic en avif",
  ],
  alternates: { canonical: "https://heictojpg.fr/heic-vs-avif" },
};

export default function HeicVsAvifPage() {
  const data = getComparison("heic-vs-avif")!;
  ...
  return (
    <>
      <PageHero>
        <Breadcrumbs items={[{ label: "HEIC vs AVIF", href: "/heic-vs-avif" }]} />

        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">HEIC vs AVIF : quel format choisir ?</h1>
        <p className="text-lg text-gray-500 mb-10 leading-relaxed">
          Le HEIC et l&apos;AVIF sont deux formats photo modernes avec une compression avanc&apos;ee.
          Le HEIC domine sur les appareils Apple, tandis que l&apos;AVIF est un format libre pleb&apos;iscit&apos;e
          pour le web. D&apos;ecouvrez lequel choisir selon vos besoins.
        </p>
      </PageHero>
      ...
      <div className="bg-white rounded-lg shadow-sm p-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <Link
            href="/convertir-avif-en-jpg"
            className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition text-center font-medium text-blue-700"
          >
            Convertir AVIF en JPG
          </Link>
          <Link
            href="/convertir-avif-en-png"
            className="block p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition text-center font-medium text-blue-700"
          >
