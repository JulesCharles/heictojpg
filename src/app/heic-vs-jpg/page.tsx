...
export const metadata: Metadata = {
  title: "HEIC vs JPG : quel format choisir ? Comparatif [2026]",
  description:
  ...
  keywords: [
    ...
    "difference heic jpg",
    "format photo iphone",
    "heic jpeg comparaison",
    "heic vs jpeg",
    "convertir heic en jpg",
  ],
  alternates: { canonical: "https://heictojpg.fr/heic-vs-jpg" },
};

export default function HeicVsJpgPage() {
  const data = getComparison("heic-vs-jpg")!;
  ...
  return (
    <>
      <PageHero>
        <Breadcrumbs items={[{ label: "HEIC vs JPG", href: "/heic-vs-jpg" }]} />

        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">HEIC vs JPG : quel format choisir ?</h1>
        <p className="text-lg text-gray-500 mb-10 leading-relaxed">
          Le HEIC et le JPG sont les deux formats photo les plus courants. Le HEIC est le format par
          d&apos;efaut des iPhone, tandis que le JPG est le standard universel. D&apos;ecouvrez les
          diff&apos;erences et lequel choisir.
        </p>
      </PageHero>
