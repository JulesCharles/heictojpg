...
export const metadata: Metadata = {
  title: "PDF vs JPG : quel format choisir ? Comparatif [2026]",
  description:
  ...
  keywords: [
    ...
    "pdf ou jpg",
    "difference pdf jpg",
    "pdf jpeg comparaison",
    "convertir pdf en jpg",
    "convertir jpg en pdf",
    "pdf vs jpeg",
  ],
  alternates: { canonical: "https://heictojpg.fr/pdf-vs-jpg" },
};

export default function PdfVsJpgPage() {
  const data = getComparison("pdf-vs-jpg")!;
  ...
  return (
    <>
      <PageHero>
        <Breadcrumbs items={[{ label: "PDF vs JPG", href: "/pdf-vs-jpg" }]} />

        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">PDF vs JPG : quel format choisir ?</h1>
        <p className="text-lg text-gray-500 mb-10 leading-relaxed">
          Le PDF est le format standard pour les documents, tandis que le JPG est le format
          universel pour les images. Deux formats compl&apos;ementaires avec des usages bien
          distincts. D&apos;ecouvrez lequel choisir selon votre situation.
        </p>
      </PageHero>
