  ...
  return (
    <EditImageForm title="Changer le DPI" action="dpi" buildFormData={(fd) => fd.set("dpi", dpi)}>
      <div className="space-y-2">
        <Label className="text-sm font-medium">Résolution (DPI)</Label>
        ...
        <p className="text-xs text-gray-500 mt-1">72 DPI = web, 150 DPI = bureautique, 300 DPI = impression, 600 DPI = haute qualité</p>
      </div>
    </EditImageForm>
  );
}