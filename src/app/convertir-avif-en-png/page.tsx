      ...
      mainEntity: [
        {
          ...
          acceptedAnswer: { "@type": "Answer", text: "Oui, si votre fichier AVIF contient de la transparence, elle sera parfaitement preservee dans le PNG." },
        },
        {
          "@type": "Question",
          name: "Le fichier PNG sera-t-il plus gros ?",
          acceptedAnswer: { "@type": "Answer", text: "Oui, le PNG est moins compresse que l'AVIF. C'est le prix de la compatibilite universelle. Pour l'usage web, gardez le format AVIF." },
        }
      ],
    },
  ],
    ...
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Transformez vos images AVIF en PNG pour une qualite sans perte et une compatibilite totale. La transparence de l'AVIF est preservee dans le PNG. Ouvrez et editez vos fichiers AVIF dans n'importe quel logiciel.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
        ...
        <div className="prose prose-gray max-w-none">
          <p className="text-gray-600 mb-4">La conversion AVIF vers PNG est ideale quand vous avez besoin d'une compatibilite maximale avec les logiciels d'edition tout en conservant la transparence. Le PNG est reconnu par tous les logiciels de retouche photo sans exception.</p>
          <p className="text-gray-600 mb-4">Si votre image AVIF contient de la transparence (canal alpha), celle-ci sera parfaitement preservee dans le fichier PNG. Cela rend cette conversion particulierement utile pour les designers qui recoivent des assets en AVIF et doivent les editer dans des outils qui ne supportent pas encore ce format.</p>
          <p className="text-gray-600 mb-4">Le fichier PNG resultant sera plus volumineux que l'AVIF original, mais il sera compatible avec absolument tous les logiciels et systemes.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">Oui, si votre fichier AVIF contient de la transparence, elle sera parfaitement preservee dans le PNG.</p>
          </div>

          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Le fichier PNG sera-t-il plus gros ?</h3>
            <p className="text-gray-600 mb-4">Oui, le PNG est moins compresse que l'AVIF. C'est le prix de la compatibilite universelle. Pour l'usage web, gardez le format AVIF.</p>
          </div>
        </div>
      </div>
