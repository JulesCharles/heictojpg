  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">Pivotez les pages de votre document PDF de 90, 180 ou 270 degrés. Corrigez l'orientation de documents scannés, de pages en mode paysage, ou de PDF mal orientés. Appliquez la rotation à toutes les pages ou à une sélection. Gratuit.</p>
      </div>
