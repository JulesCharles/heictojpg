...
const editTools: Tool[] = [
  ...
  { href: "/convertir-image-en-pixel-art", label: "Pixel art", desc: "Effet retro pixelise.", icon: "PXL" },
  { href: "/convertir-image-en-ascii", label: "ASCII art", desc: "Image en caracteres.", icon: "ASC" },
  ...
  { href: "/comparer-images", label: "Comparer images", desc: "Avant/apres slider.", icon: "CMP" },
  { href: "/generateur-favicon", label: "Generateur favicon", desc: "Toutes tailles + ZIP.", icon: "FAV" },
