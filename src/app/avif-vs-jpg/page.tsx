...
export const metadata: Metadata = {
  title: "AVIF vs JPG : quel format choisir ? Comparatif [2026]",
  description:
  ...
  keywords: [
    ...
    "difference avif jpg",
    "avif vs jpeg",
    "avif jpeg comparaison",
    "format image moderne",
    "convertir avif en jpg",
  ],
  alternates: { canonical: "https://heictojpg.fr/avif-vs-jpg" },
};

export default function AvifVsJpgPage() {
  const data = getComparison("avif-vs-jpg")!;
  ...
  return (
    <>
      <PageHero>
        <Breadcrumbs items={[{ label: "AVIF vs JPG", href: "/avif-vs-jpg" }]} />

        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">AVIF vs JPG : quel format choisir ?</h1>
        <p className="text-lg text-gray-500 mb-10 leading-relaxed">
          L&apos;AVIF est le format d&apos;image nouvelle g&apos;en&apos;eration qui promet de
          remplacer le JPG. D&apos;ecouvrez les diff&apos;erences entre ces deux formats et lequel
